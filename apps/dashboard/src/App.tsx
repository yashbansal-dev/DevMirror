...
import { Activity, Terminal, Server, Network, Stethoscope, CheckCircle, AlertTriangle, Layers, Cpu } from 'lucide-react';

export default function App() {
  const [activeTab, setActiveTab] = useState<'overview' | 'logs' | 'services' | 'architecture' | 'diagnostics'>('overview');
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '24px 28px', maxWidth: '1400px', width: '100%', margin: '0 auto' }}>
        ...
        {activeTab === 'logs' && (
          <div className="glass-card" style={{ background: '#090d16' }}>
        ...
        {activeTab === 'services' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {mockProject.services.map((s, idx) => (
              <div key={idx} className="glass-card" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
