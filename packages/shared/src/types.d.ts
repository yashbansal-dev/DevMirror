export type StackLanguage = 'javascript' | 'typescript' | 'python' | 'go' | 'rust' | 'java' | 'cpp' | 'php' | 'ruby' | 'unknown';
export type PackageManager = 'npm' | 'pnpm' | 'yarn' | 'bun' | 'pip' | 'poetry' | 'uv' | 'pipenv' | 'cargo' | 'go' | 'maven' | 'gradle' | 'composer' | 'bundler';
export type DatabaseType = 'postgres' | 'mysql' | 'mongodb' | 'redis' | 'rabbitmq' | 'elasticsearch' | 'sqlite';
